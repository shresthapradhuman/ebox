...
const layout = async({children}: {
  ...
  return (
    <SidebarProvider>
      ...
      <SidebarInset>
        {/* header */}
        <header className="group-has-data-[collapsible=icon]/sidebar-wrapper:h-[2.8rem] flex h-[2.8rem] shrink-0 items-center gap-2 border-b transition-[width,height] ease-linear">
